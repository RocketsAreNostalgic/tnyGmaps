(function() {
   tinymce.create('tinymce.plugins.trgmaps', {
      init : function(ed, url) {
         // Register commands
         ed.addCommand('trgmaps', function() {
         ...
         // Register buttons
         ed.addButton('trgmaps', {
            title : 'GMaps',
            image : url+'/img/icons/music_folk_map.png',
            cmd : 'trgmaps'
         });
      },
      getInfo : function() {
   ...
   tinymce.PluginManager.add('trgmaps', tinymce.plugins.trgmaps);
})();