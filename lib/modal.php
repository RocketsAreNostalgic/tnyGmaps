...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <link type="text/css" rel="stylesheet" href="<?php echo esc_url($local_uri); ?>../assets/css/tnygmaps_frontend.css"/>
        <link type="text/css" rel="stylesheet" href="<?php echo esc_url($local_uri); ?>../assets/css/tnygmaps_modal.css"/>
        <link type="text/css" rel="stylesheet" href="<?php echo esc_url($local_uri); ?>../assets/js/vendor/jquery-qtip-custom/jquery.qtip.css"/>
        <script>
            /* <![CDATA[ */
            <?php if ( $api_test ) { ?>
    ...
    <div id="overlay" class=""></div>
        ...
        <div id="tnygmaps" class="wrap">
            <form action="/" method="get" accept-charset="utf-8">
                ...
                <div class="group <?php echo ( ! $api_test ) ? 'hidden' : '' ?>	" id="mapAddress-group">
                    <label class="heading" for="mapAddress"> <?php esc_html_e( 'Address lookup', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php echo sprintf( __( 'This section uses the Google Places API to find details about places of interest on found on Google Maps. The details are auto-updated when owners refresh information using Google‘s services.', 'orionrush-tnygmaps' ), '<br/>', '<br/>', '<br/>', '<br/>', '<br/>' ) ?>">?</span>
                    </label>
                    <div class="autoMapAddress input">
                        <input type="text" name="mapAddressAuto" id="mapAddress" class="noEnterSubmit"/>
                    </div>
                </div>
                <label class="heading"><?php esc_html_e( 'Custom details', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php echo sprintf( __( 'This section uses Google‘s Gocodng API to validate addresses, and so does not automatically update information about the location the future, (like phone numbers or website addresses). Use this tool if %sAddress lookup%s can‘t find or provides incorrect/incomplete results. %s%s If you just want to add a website or phone number, consider adding these to the %sWindow Extras%s section instead.', 'orionrush-tnygmaps' ), '<strong>', '</strong>', '<br/>', '<br/>', '<strong>', '</strong>' ) ?>">?</span>
                </label>
                ...
                <div class="group">
                    <div id="address_extras" class="accordion" style="display:none;">
                        ...
                        <div class="input ">
                            ...
                            <input type="text" placeholder="<?php esc_html_e( 'Joes Music Emporium', 'orionrush-tnygmaps' ); ?>"
                                   name="locName"
                        ...
                        <div class="input float large">
                            <label for="locWebsite"><?php esc_html_e( 'Website', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php esc_html_e( 'If you provide a full url (including http://) an outside link will be created. If you provide a page-slug a local link will be rendered ie &quot;about-us&quot;.', 'orionrush-tnygmaps' ); ?>">?</span><br/>
                            </label>
                            <input type="text" name="locWebsite" placeholder="http://www.someplace.com" id="locWebsite"
                                   class="noEnterSubmit" disabled/>
                        </div>
                        <div class="input float med">
                            <label for="locPhone"><?php esc_html_e( 'Primary phone', 'orionrush-tnygmaps' ); ?>:</label><br/>
                ...
                <label class="heading"><?php esc_html_e( 'Window extras', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php esc_html_e( 'Add custom information to the marker info window. Allowed HTML is auto corrected to prevent malformed markup from breaking your page. Longer blocks of markup should be copy-pasted in.', 'orionrush-tnygmaps' ); ?>">?</span>
                </label>
                <div class="group">
                    <div class="input">
                ...
                <label class="heading"><?php esc_html_e( 'Map attributes', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php esc_html_e( 'Adjust the appearence of your map.', 'orionrush-tnygmaps' ); ?>">?</span></label>
                <div class="group">
                    ...
                    <div id="map_extras" class="accordion" style="display:none;">
                        ...
                        <div class="mapMarkerImage_wrap">
                            <div class="input">
                                <label class="heading" for="mapMarkerImage"><?php esc_html_e( 'Custom icon URL', 'orionrush-tnygmaps' ); ?>: <span data-tooltip="<?php esc_html_e( 'List the full (or root realitive) path to your custom icon, or select from the list below. If your custom icon won&#039;t load, then there is probably a typo in your path.', 'orionrush-tnygmaps' ); ?>">?</span>
                                </label>
                                <input type="text"
                                       name="mapMarkerImage"
                                       placeholder="<?php echo esc_attr(loaded_icons_url()); ?>/"
                                       value="<?php echo esc_url(loaded_icons_url()); ?><?php echo esc_attr( $loaded_icons[0] ); ?>"
                                       id="mapMarkerImage"
                                />
        ...
        <div class="map-preview">
            <div class="map-wrap tnygmps_wrap">
                ...
                <div class="tnygmps_link_wrap"><a href="#" class="tnygmps_ext_lnk" onclick="return false;" target=""><?php echo esc_html(Support\openMapInNewWin()); ?></a></div>
            </div>
