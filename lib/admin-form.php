...
function admin_markup() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <label for="tnygmaps_api_key"><?php _e( 'Google Maps API key:', 'orionrush-tnygmaps' ); ?></label>
            ...
            <label for="tnygmaps_custom_icon"><?php _e( 'Choose a default map icon:', 'orionrush-tnygmaps' ); ?></label>
            ...
            <label for="tnygmaps_custom_icon"><?php _e( 'Your icon URL:', 'orionrush-tnygmaps' ); ?></label>
